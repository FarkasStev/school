...
public class WeatherDatumContentFactory
{
  ...
  public WeatherDatumContentFactory(Map<String, Point2D> locations, Map<String, Image> images)
  {
  ...
  {
    return new WeatherDatumContent(datum, color, locations.get(datum.getLocation()),
