    ...
    implements java.awt.event.ActionListener
{
  ...
  public WeatherBitmapsApplication(final String[] args)
  {
    ...
    try
    {
      ...
      BufferedReader aboutReader = new BufferedReader(new FileReader(aboutFile));
      String aboutString = "";

      String temp = aboutReader.readLine();
      aboutString += temp;
      aboutString += '\n';

      while (temp != null)
      {
        temp = aboutReader.readLine();
        if (temp != null)
        {
          aboutString += temp;
          aboutString += '\n';
    ...
    {
      JOptionPane.showMessageDialog(null, null, "Error: about.txt not able to be read",
  ...
  protected void handleLoad()
  {
    ...
    try
    {
      ...
      // see if the reader was created properly
      if (reader == null)
      {
